...
//------------------------------
//Class which stores all vital parameters and has all functions to solve the problem
//------------------------------
template <int dim>
class Problem
{
...
//------------------------------
template <int dim>
Problem<dim>::Problem() : dof_handler(triangulation), max_degree(dim <= 2 ? 7 : 5)
{
...
//------------------------------
//Destructor for the Problem class
//------------------------------
template <int dim>
Problem<dim>::~Problem()
{
...
void Problem<dim>::make_grid()
{
    ...
    //Demo:
    /*Triangulation<3> tmp_triangulation_upper_rectangle;
    Triangulation<3> tmp_triangulation_lower_rectangle;
    GridGenerator::hyper_rectangle(tmp_triangulation_upper_rectangle, Point<3>(-1,0,0), Point<3>(1,1,2));
    GridGenerator::hyper_rectangle(tmp_triangulation_lower_rectangle, Point<3>(-1,-1,0), Point<3>(0,0,2));

    GridGenerator::merge_triangulations(tmp_triangulation_upper_rectangle,tmp_triangulation_lower_rectangle,triangulation);
    //GridTools::rotate(-M_PI/2.0,triangulation);
    triangulation.refine_global(2);*/
    /*
    GridGenerator::hyper_rectangle(triangulation, Point<dim>(-1,0,0), Point<dim>(1,1,2));
    triangulation.refine_global(2);
    */
    GridGenerator::hyper_rectangle(triangulation, Point<2>(-0.5,0), Point<2>(0.5,1));
    triangulation.refine_global(2);
